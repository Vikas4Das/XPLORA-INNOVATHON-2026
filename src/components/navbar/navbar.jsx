...
const Navbar = () => {
  ...
  const handleRegisterClick = () => {
    ...
    window.open("https://forms.gle/fuHo3wQSTVpbZqpD7");
  };
      ...
      <div className="parent">
        <div className="components">
          <div className="title" onClick={() => window.open("/", "_self")}>
            <img src="/images/Xplora Logo.png" className="logo" alt="Logo" />
            Innovathon
      ...
      <div className="main-navbar-mobile">
        <div className="parent-navbar-mobile">
          <div className="components-mobile">
            ...
            >
              <img src="/images/Xplora Logo.png" width="30vw" alt="logo" />
              Innovathon
            </div>
            <div className="last-mobile">
              <h2 className="register-mobile">
                <a href="https://forms.gle/fuHo3wQSTVpbZqpD7" target="_blank" rel="noreferrer">
                  Register
                </a>
              </h2>
            </div>
